...
model_directory = r'D:\Matakuliah Semester 5\Pembelajaran Mesin dan Pembelajaran Mendalam\Deep Learning\Introduction to Deep Learning (Praktek)'
...
if os.path.exists(model_path):
    try:
        ...
        st.title("Fashion MNIST Image Classifier - 1777")
